...
archiveValue = (time, param, value) ->
  ...
  if !fs.existsSync "#{ARCHIVE_PATH}/#{path}"
    rrdtool.stdin.write "create #{path} --step 60 DS:value:GAUGE:300:U:U RRA:AVERAGE:0.5:5:288 RRA:AVERAGE:0.5:120:360 RRA:AVERAGE:0.5:1440:360 RRA:MAX:0.5:120:360 RRA:MAX:0.5:1440:360 RRA:MIN:0.5:120:360 RRA:MIN:0.5:1440:360\n"
